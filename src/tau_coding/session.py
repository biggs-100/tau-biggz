    ...
    async def prompt(
        ...
        *,
        ...
        try:
            ...
            get_default_registry().dispatch_event(
                "after_prompt", {"session": self, "prompt": expanded_content}
            )
...
# ---------------------------------------------------------------------------
from tau_coding.session_export import (  # noqa: E402
    _resolve_export_destination,
    _session_export_title,
    _storage_path,
)
from tau_coding.session_provider import (  # noqa: E402
